...
public class T_Edit_and_Submit1 {
	public 	WebDriver driver;
	public	Extent_Reports e = new Extent_Reports(driver);
	public	Excel_Util data = new Excel_Util();	

	public T_Edit_and_Submit1(WebDriver driver, Extent_Reports e) {
	...
	@FindBy(xpath = "//td[.='$6,123.00']/parent::tr/td/ion-button[@title='Edit Application']")
